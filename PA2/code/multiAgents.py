...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def minAB(self, state, d, unvisitedGhosts, numOfAgent, agentIndex,alpha, beta):
      ...
      # if state.isWin() or state.isLose() or  d == 0 or len(nextStatesList) == 0:
      #   return self.evaluationFunction(state) 
      ...
      if not (unvisitedGhosts== 0):
        for nextState in nextStatesList:
          ...
          # if alpha > beta:
          #   break;
          # if finalminValue < beta:
          #   beta = finalminValue
          # if alpha > beta:
          #   return alpha

          # if (finalminValue < alpha):
          #   print "beta value in min AB ",beta
          #   print "alpha in minAB :::::::" , alpha
          #   return finalminValue
          # beta = min(beta ,finalminValue)
